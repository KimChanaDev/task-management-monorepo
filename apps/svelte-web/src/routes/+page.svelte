...
<div class="min-h-[calc(100vh-4rem)] bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
	...
	<div class="container mx-auto px-3 sm:px-4 md:px-6 py-12 sm:py-16">
		...
		>
			...
			>
				...
				<h3 class="text-xl sm:text-2xl font-bold mb-2 sm:mb-3 text-gray-900">Real-time Updates</h3>
			...
			>
				...
				<p class="text-sm sm:text-base text-gray-600 leading-relaxed">
					Enterprise-grade security with JWT-based authentication and automatic token rotation. Your
			...
			>
				...
				<p class="text-sm sm:text-base text-gray-600 leading-relaxed">
					Track productivity with comprehensive metrics and insights. Make data-driven decisions for
					your team.
				</p>
			</div>
			...
			>
				...
				<h3 class="text-xl sm:text-2xl font-bold mb-2 sm:mb-3 text-gray-900">Team Collaboration</h3>
				<p class="text-sm sm:text-base text-gray-600 leading-relaxed">
	...
	<div class="container mx-auto px-3 sm:px-4 md:px-6 py-12 sm:py-16 md:py-20">
		...
		>
			...
			>
				Join thousands of teams who are already managing their tasks more effectively with TaskFlow.
			</p>
			<a
				href={resolve('/auth/register')}
