...
>
	<div class="max-w-md w-full">
		...
		<div
			class="bg-white rounded-2xl shadow-2xl p-8 space-y-6 border border-gray-100 backdrop-blur-sm"
		>
			<!-- Header with icon -->
			<div class="text-center space-y-2">
				...
				<p class="text-gray-500 text-sm">Join us to start managing your tasks efficiently</p>
			</div>
			...
			<form onsubmit={handleSubmit} class="space-y-5">
				...
				<!-- <div class="flex items-start pt-2">
					<input
						...
						type="checkbox"
						required
						class="h-4 w-4 mt-1 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded transition-colors"
					/>
